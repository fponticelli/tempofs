...
export const template = HTML_El_Z7374416F("sp-theme", ofArray([HTML_Attr_Z384F8060("scale", "smallest"), HTML_Attr_Z384F8060("color", "light"), HTML_Attr_Z384F8060("style", "background: var(--spectrum-global-color-gray-75); padding: var(--spectrum-global-dimension-size-400);")]), ofArray([HTML_El_Z7374416F("div", singleton(HTML_Attr_Z384F8060("style", "display: flex; justify-content: space-between;")), ofArray([HTML_El_Z7374416F("sp-action-group", singleton(HTML_Attr_Z384F8060("compact", "compact")), ofArray([HTML_El_Z7374416F("sp-action-button", singleton(HTML_On_4A53169E("click", new Action(1, -10))), singleton(HTML_Text_Z721C83C5("-10"))), HTML_El_Z7374416F("sp-action-button", singleton(HTML_On_4A53169E("click", new Action(1, -1))), singleton(HTML_Text_Z721C83C5("-"))), HTML_El_Z7374416F("sp-action-button", singleton(HTML_On_4A53169E("click", new Action(1, 1))), singleton(HTML_Text_Z721C83C5("+"))), HTML_El_Z7374416F("sp-action-button", singleton(HTML_On_4A53169E("click", new Action(1, 10))), singleton(HTML_Text_Z721C83C5("+10")))])), HTML_El_Z7374416F("sp-number-field", ofArray([HTML_On_47AABEE2("input", (_arg1) => (new Action(2, _arg1.Element.value))), HTML_Attr_3DF4EB53("value", (_arg2) => toText(interpolate("%P()", [_arg2.Counter])))]), empty()), HTML_El_Z7374416F("sp-textfield", singleton(HTML_On_4A53169E("change", new Action(1, -1))), empty()), HTML_El_Z7374416F("sp-action-button", singleton(HTML_On_4A53169E("click", new Action(0))), singleton(HTML_Text_Z721C83C5("reset")))])), HTML_El_Z7374416F("sp-slider", ofArray([HTML_On_47AABEE2("input", (_arg3) => (new Action(2, _arg3.Element.value))), HTML_Attr_3DF4EB53("value", (_arg4) => toText(interpolate("%P()", [_arg4.Counter]))), HTML_Attr_Z384F8060("label", "Slider"), HTML_Attr_Z384F8060("variant", "tick"), HTML_Attr_Z384F8060("tick-labels", "tick-labels"), HTML_Attr_Z384F8060("tick-step", "10")]), empty()), HTML_El_Z7374416F("div", singleton(HTML_Attr_Z384F8060("style", "padding: 20px 0")), singleton(HTML_El_Z7374416F("sp-card", ofArray([HTML_Attr_3DF4EB53("heading", (_arg5) => toText(interpolate("counting ... %P()", [_arg5.Counter]))), HTML_Attr_Z384F8060("subheading", "No Preview")]), singleton(HTML_El_Z7374416F("div", singleton(HTML_Attr_Z384F8060("slot", "footer")), singleton(HTML_El_Z7374416F("sp-progress-circle", ofArray([HTML_Attr_Z384F8060("label", "Done?"), HTML_Attr_Z3A5D29FA("progress", (_arg6) => {
...
}), HTML_Attr_Z384F8060("size", "large")]), empty()))))))), HTML_El_Z7374416F("div", empty(), ofArray([HTML_Text_Z721C83C5("count: "), map((x) => x, (_arg8) => _arg8.Counter, (arg0) => arg0, () => {
...
}))), HTML_OneOf_Z2AFE4804((v) => ((v > 9) ? (new FSharpChoice$2(0, " ... Great!")) : ((v > 4) ? (new FSharpChoice$2(1, v)) : (new FSharpChoice$2(2, void 0)))), HTML_Text(), HTML_Text_77A7E8C8((s_1) => toText(interpolate(" ... %P() is a good number", [s_1]))), HTML_Text_Z721C83C5(" ... meh"))])))])), HTML_El_Z7374416F("ul", empty(), singleton(HTML_Seq_Z7461BB91((_arg9) => toList(rangeDouble(1, 1, _arg9.Counter)), HTML_El_Z7374416F("li", empty(), singleton(HTML_Text_77A7E8C8((i) => toText(interpolate("Item: %P()", [i]))))))))]));
...
export function update(state_1, action) {
    switch (action.tag) {
        ...
        case 2: {
            return new State(action.fields[0]);
        }
        default: {
...
export function middleware(_arg1) {
    console.log(some(toText(interpolate("Action: %P(), State: %P(), Previous %P()", [_arg1.Action, _arg1.Current, _arg1.Previous]))));
}
