...
import { DSL_Component_Z228F47D0, DSL_NSEl_7639458A, DSL_Text_Z721C83C5, DSL_Attr_30230F9B, DSL_On_3B61A1E2, DSL_Attr_Z384F8060, DSL_El_Z7374416F } from "../Tempo.Html/Html.DSL.fs.js";
...
export function update(state, action) {
    switch (action.tag) {
        ...
        default: {
            const on = action.fields[0];
            return new Html2TempoState(on);
        }
    }
}
...
export const template = DSL_El_Z7374416F("div", singleton(DSL_Attr_Z384F8060("class", "flex flex-col h-screen")), ofArray([bar, DSL_El_Z7374416F("div", singleton(DSL_Attr_Z384F8060("class", "flex h-full")), ofArray([DSL_El_Z7374416F("div", ofArray([DSL_Attr_Z384F8060("class", "flex-auto h-full w-6/12"), MonacoEditorAttribute((_arg1) => ({
    ...
    const filterComments = _arg2.FilterComments;
    return {
        language: "fsharp",
